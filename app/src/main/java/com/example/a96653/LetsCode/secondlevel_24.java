...
public class secondlevel_24 extends AppCompatActivity {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondlevel_24);
        ...
        ImageButton home=(ImageButton)findViewById(R.id.homebtn_secondLeve20);

        home.setOnClickListener( new ImageButton.OnClickListener(){

            @Override
            public void onClick(View v) {
                startActivity(new Intent(secondlevel_24.this,MainActivity.class));
    ...
    public void ShowPopup() {
        ...
        Button btnClose;
        myDialog.setContentView(R.layout.hint2_4);
