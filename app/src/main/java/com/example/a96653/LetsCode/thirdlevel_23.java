...
public class thirdlevel_23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirdlevel_23);
        ...
        home.setOnClickListener( new ImageButton.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(thirdlevel_23.this,MainActivity.class));
        ...
        ImageView next=(ImageView)findViewById(R.id.nextquiz3_1);
        ...
        next.setOnClickListener( new ImageView.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(radio1.isChecked()) {
                    SharedPreferences prefs = getSharedPreferences("pref_thirdLevel_23", MODE_PRIVATE);
                    boolean firstStart = prefs.getBoolean("firstStart", true);
                    if (firstStart){
                        mySqliteOpenHelper.UpdateNumOfLesson(51,"Saturn");
                        SharedPreferences pref = getSharedPreferences("pref_thirdLevel_23", MODE_PRIVATE);
                        SharedPreferences.Editor editor = prefs.edit();
                        editor.putBoolean("firstStart", false);
                        editor.apply();}
                    startActivity(new Intent(thirdlevel_23.this,thirdlevel_24.class));
                    mySqliteOpenHelper.UpdateQuestionAnswer(11, 0);
                ...
                if(radio2.isChecked()){
                    ...
                    if (firstStart){
                        ...
                        editor.putBoolean("firstStart", false);
                        editor.apply();}
                    mySqliteOpenHelper.UpdateQuestionAnswer(11,1);
                    startActivity(new Intent(thirdlevel_23.this,thirdlevel_24.class));
                }
    ...
    public void ShowPopup() {
        ...
        Button btnClose;
        myDialog.setContentView(R.layout.hint3_4);
